...
public final class d2 extends ContentProvider {
    ...
    public final void attachInfo(Context context, ProviderInfo providerInfo) {
        ...
        try {
            ...
            er.zzg("Failed to load metadata: Package name not found.", e2);
        } catch (NullPointerException e3) {
            er.zzg("Failed to load metadata: Null pointer exception.", e3);
        }
        lf lfVarA = lf.a();
        if (bundle == null) {
            er.zzf("Metadata was null.");
        } else {
            try {
                        ...
                        try {
                            ...
                            if (str == null || str.matches("^/\\d+~.+$")) {
                                if (bool == null || !bool.booleanValue()) {
                                    ...
                                    er.zzd(strValueOf.length() != 0 ? "The Google Mobile Ads SDK is integrated by ".concat(strValueOf) : new String("The Google Mobile Ads SDK is integrated by "));
                                }
                            } else {
                                if (!str.matches("^ca-app-pub-[0-9]{16}~[0-9]{10}$")) {
                                    throw new IllegalStateException("\n\n******************************************************************************\n* Invalid application ID. Follow instructions here:                          *\n* https://googlemobileadssdk.page.link/admob-android-update-manifest         *\n* to find your app ID.                                                       *\n******************************************************************************\n\n");
                                }
                                er.zzd(str.length() != 0 ? "Publisher provided Google AdMob App ID in manifest: ".concat(str) : new String("Publisher provided Google AdMob App ID in manifest: "));
                                if (bool2 == null || !bool2.booleanValue()) {
                                    lfVarA.b(context, str);
                                }
                            }
