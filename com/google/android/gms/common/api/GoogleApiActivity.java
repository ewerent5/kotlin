...
public class GoogleApiActivity extends Activity implements DialogInterface.OnCancelListener {
    ...
    protected void onActivityResult(int i2, int i3, Intent intent) {
        ...
        if (i2 == 1) {
            ...
            setResult(i3, intent);
            if (booleanExtra) {
                com.google.android.gms.common.api.internal.b bVarD = com.google.android.gms.common.api.internal.b.d(this);
                if (i3 == -1) {
                    bVarD.q();
                } else if (i3 == 0) {
                    bVarD.b(new com.google.android.gms.common.b(13, null), getIntent().getIntExtra("failing_client_id", -1));
                }
            }
        } else if (i2 == 2) {
            this.f4524e = 0;
    ...
    protected void onCreate(Bundle bundle) throws IntentSender.SendIntentException {
        ...
        if (bundle != null) {
            this.f4524e = bundle.getInt("resolution");
        }
        if (this.f4524e != 1) {
            ...
            if (pendingIntent == null && num == null) {
                ...
                if (pendingIntent == null) {
                    com.google.android.gms.common.e.l().m(this, num.intValue(), 2, this);
                    this.f4524e = 1;
                    return;
                }
                try {
    ...
    protected void onSaveInstanceState(Bundle bundle) {
        bundle.putInt("resolution", this.f4524e);
