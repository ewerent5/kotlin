...
public final class k7 extends w5 {
    ...
    private final SSLSocketFactory f10983c;

    k7(z4 z4Var) {
        super(z4Var);
        this.f10983c = Build.VERSION.SDK_INT < 19 ? new fa() : null;
    }
    ...
    protected final HttpURLConnection p(URL url) throws IOException {
        URLConnection uRLConnectionOpenConnection = url.openConnection();
        if (!(uRLConnectionOpenConnection instanceof HttpURLConnection)) {
            throw new IOException("Failed to obtain HTTP connection");
        }
        SSLSocketFactory sSLSocketFactory = this.f10983c;
