...
class i0 {
    ...
    public void e(View view, int i2, int i3, int i4, int i5) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        b();
        Method method = a;
        if (method != null) {
            try {
    ...
    public void g(View view, int i2) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
        ...
        if (field != null) {
            try {
                f3374c.setInt(view, i2 | (field.getInt(view) & (-13)));
