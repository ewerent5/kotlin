...
class b {
    ...
    public interface InterfaceC0063b<T, V> {
        V a(T t, int i2);
    ...
    /* compiled from: FocusStrategy.java */
    private static class c<T> implements Comparator<T>, j$.util.Comparator {

        /* renamed from: e, reason: collision with root package name */
        private final Rect f3202e = new Rect();

        /* renamed from: f, reason: collision with root package name */
        private final Rect f3203f = new Rect();

        /* renamed from: g, reason: collision with root package name */
        private final boolean f3204g;

        /* renamed from: h, reason: collision with root package name */
        private final a<T> f3205h;
        ...
        public int compare(T t, T t2) {
            Rect rect = this.f3202e;
            Rect rect2 = this.f3203f;
            this.f3205h.a(t, rect);
            this.f3205h.a(t2, rect2);
            int i2 = rect.top;
            int i3 = rect2.top;
            if (i2 < i3) {
                return -1;
    ...
    public static <L, T> T c(L l2, InterfaceC0063b<L, T> interfaceC0063b, a<T> aVar, T t, Rect rect, int i2) {
        ...
        T t2 = null;
        int iB = interfaceC0063b.b(l2);
        Rect rect3 = new Rect();
        for (int i3 = 0; i3 < iB; i3++) {
            T tA = interfaceC0063b.a(l2, i3);
            if (tA != t) {
                aVar.a(tA, rect3);
    ...
    public static <L, T> T d(L l2, InterfaceC0063b<L, T> interfaceC0063b, a<T> aVar, T t, int i2, boolean z, boolean z2) {
        int iB = interfaceC0063b.b(l2);
        ArrayList arrayList = new ArrayList(iB);
        for (int i3 = 0; i3 < iB; i3++) {
            arrayList.add(interfaceC0063b.a(l2, i3));
        }
