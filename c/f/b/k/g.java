...
public class g extends e {
    ...
    public void g(c.f.b.d dVar, boolean z) {
        ...
        if (this.F0 == -1) {
            if (this.D0 != -1.0f) {
                dVar.d(c.f.b.d.s(dVar, dVar.q(this.G0), dVar.q(dVarM2), this.D0));
                return;
            }
            return;
        }
        c.f.b.i iVarQ4 = dVar.q(this.G0);
        c.f.b.i iVarQ5 = dVar.q(dVarM2);
