...
public class e {
    ...
    */
    ...
    private static PropertyValuesHolder e(TypedArray typedArray, int i2, int i3, int i4, String str) {
        ...
        c.b[] bVarArrD = c.h.d.c.d(string);
        c.b[] bVarArrD2 = c.h.d.c.d(string2);
        ...
        if (bVarArrD2 == null) {
            ...
            if (!c.h.d.c.b(bVarArrD, bVarArrD2)) {
    ...
    private static int g(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray typedArrayS = androidx.core.content.c.g.s(resources, theme, attributeSet, c.t.a.a.a.f3438j);
        int i2 = 0;
        TypedValue typedValueT = androidx.core.content.c.g.t(typedArrayS, xmlPullParser, "value", 0);
    ...
    private static ValueAnimator l(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f2, XmlPullParser xmlPullParser) {
        TypedArray typedArrayS = androidx.core.content.c.g.s(resources, theme, attributeSet, c.t.a.a.a.f3435g);
        TypedArray typedArrayS2 = androidx.core.content.c.g.s(resources, theme, attributeSet, c.t.a.a.a.f3439k);
        if (valueAnimator == null) {
            valueAnimator = new ValueAnimator();
        }
        q(valueAnimator, typedArrayS, typedArrayS2, f2, xmlPullParser);
        int iL = androidx.core.content.c.g.l(typedArrayS, xmlPullParser, "interpolator", 0, 0);
        if (iL > 0) {
    ...
    private static Keyframe m(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i2, XmlPullParser xmlPullParser) {
        TypedArray typedArrayS = androidx.core.content.c.g.s(resources, theme, attributeSet, c.t.a.a.a.f3438j);
        float fJ = androidx.core.content.c.g.j(typedArrayS, xmlPullParser, "fraction", 3, -1.0f);
        TypedValue typedValueT = androidx.core.content.c.g.t(typedArrayS, xmlPullParser, "value", 0);
        boolean z = typedValueT != null;
        if (i2 == 4) {
            i2 = (z && h(typedValueT.type)) ? 3 : 0;
        }
        Keyframe keyframeOfInt = z ? i2 != 0 ? (i2 == 1 || i2 == 3) ? Keyframe.ofInt(fJ, androidx.core.content.c.g.k(typedArrayS, xmlPullParser, "value", 0, 0)) : null : Keyframe.ofFloat(fJ, androidx.core.content.c.g.j(typedArrayS, xmlPullParser, "value", 0, 0.0f)) : i2 == 0 ? Keyframe.ofFloat(fJ) : Keyframe.ofInt(fJ);
        int iL = androidx.core.content.c.g.l(typedArrayS, xmlPullParser, "interpolator", 1, 0);
        if (iL > 0) {
        ...
        while (true) {
            ...
            if (eventType != 2) {
                ...
                if (xmlPullParser.getName().equals("propertyValuesHolder")) {
                    TypedArray typedArrayS = androidx.core.content.c.g.s(resources, theme, attributeSet, c.t.a.a.a.f3437i);
                    String strM = androidx.core.content.c.g.m(typedArrayS, xmlPullParser, "propertyName", 3);
                    int iK = androidx.core.content.c.g.k(typedArrayS, xmlPullParser, "valueType", 2, 4);
    ...
    private static void q(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f2, XmlPullParser xmlPullParser) {
        long jK = androidx.core.content.c.g.k(typedArray, xmlPullParser, "duration", 1, 300);
        long jK2 = androidx.core.content.c.g.k(typedArray, xmlPullParser, "startOffset", 2, 0);
        int iK = androidx.core.content.c.g.k(typedArray, xmlPullParser, "valueType", 7, 4);
        if (androidx.core.content.c.g.r(xmlPullParser, "valueFrom") && androidx.core.content.c.g.r(xmlPullParser, "valueTo")) {
            if (iK == 4) {
                iK = f(typedArray, 5, 6);
            }
        ...
        valueAnimator.setRepeatCount(androidx.core.content.c.g.k(typedArray, xmlPullParser, "repeatCount", 3, 0));
        valueAnimator.setRepeatMode(androidx.core.content.c.g.k(typedArray, xmlPullParser, "repeatMode", 4, 1));
        if (typedArray2 != null) {
    ...
    private static void r(ValueAnimator valueAnimator, TypedArray typedArray, int i2, float f2, XmlPullParser xmlPullParser) {
        ...
        String strM = androidx.core.content.c.g.m(typedArray, xmlPullParser, "pathData", 1);
        if (strM == null) {
            objectAnimator.setPropertyName(androidx.core.content.c.g.m(typedArray, xmlPullParser, "propertyName", 0));
            return;
        }
        String strM2 = androidx.core.content.c.g.m(typedArray, xmlPullParser, "propertyXName", 2);
        String strM3 = androidx.core.content.c.g.m(typedArray, xmlPullParser, "propertyYName", 3);
        if (i2 != 2) {
        }
        if (strM2 != null || strM3 != null) {
            s(c.h.d.c.e(strM), objectAnimator, f2 * 0.5f, strM2, strM3);
            return;
        }
