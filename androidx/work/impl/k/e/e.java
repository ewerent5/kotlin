...
public class e extends c<androidx.work.impl.k.b> {
    ...
    private static final String f2268e = androidx.work.h.f("NetworkMeteredCtrlr");
    ...
    boolean b(j jVar) {
        return jVar.f2311l.b() == i.METERED;
    }
    ...
    public boolean c(androidx.work.impl.k.b bVar) {
        ...
        androidx.work.h.c().a(f2268e, "Metered network constraint is not supported before API 26, only checking for connected state.", new Throwable[0]);
        return !bVar.a();
    }
}