...
public class AlertDialogLayout extends i0 {
    ...
    private static int B(View view) throws NoSuchFieldException {
        int iC = c.h.l.t.C(view);
        if (iC > 0) {
            return iC;
        }
    ...
    private boolean C(int i2, int i3) throws NoSuchFieldException {
        ...
        for (int i4 = 0; i4 < childCount; i4++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == c.a.f.P) {
                    view = childAt;
                } else if (id == c.a.f.f2492k) {
                    view2 = childAt;
                } else {
                    if ((id != c.a.f.f2494m && id != c.a.f.o) || view3 != null) {
                        return false;
                    }
                    view3 = childAt;
                }
    ...
    */
    protected void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L5a:
            ...
            r2 = r11
        L7e:
            int r3 = c.h.l.t.B(r17)
            int r2 = c.h.l.d.b(r2, r3)
            r2 = r2 & 7
            r3 = 1
            if (r2 == r3) goto L97
            r3 = 5
