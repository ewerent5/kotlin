...
public final class a {
    ...
    private static Method f917c;

    /* renamed from: d, reason: collision with root package name */
    private static boolean f918d;
    ...
    public static int f(Drawable drawable) throws NoSuchMethodException, SecurityException {
        int i2 = Build.VERSION.SDK_INT;
        if (i2 >= 23) {
    ...
    public static boolean m(Drawable drawable, int i2) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
