...
class C0361t2 implements InterfaceC0365u2<Long, j$.util.r, C0361t2>, A2.g {
    private boolean a;
    ...
    final /* synthetic */ j$.util.function.B f16364c;

    C0361t2(j$.util.function.B b2) {
        this.f16364c = b2;
    }
    ...
    public void accept(long j2) {
        if (this.a) {
            ...
            j2 = this.f16364c.applyAsLong(this.f16363b, j2);
        }
        this.f16363b = j2;
    }
    ...
    public Object get() {
        return this.a ? j$.util.r.a() : j$.util.r.d(this.f16363b);
    }

    @Override // j$.util.stream.InterfaceC0365u2
    public void i(InterfaceC0365u2 interfaceC0365u2) {
        C0361t2 c0361t2 = (C0361t2) interfaceC0365u2;
        if (c0361t2.a) {
            return;
        }
        accept(c0361t2.f16363b);
    }
